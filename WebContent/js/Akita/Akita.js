...
function like_callback(a, b) {
    if (b.data("disabled", !1), -1 === a.status) {
        ...
        1 === a.status ? b.removeClass("icon-fav").addClass("icon-faved").attr("title", b.data("langliked")) : 2 === a.status ? b.removeClass("icon-faved").addClass("icon-fav").attr("title", b.data("langlike")) : a.msg && $.luoo.tip(a.msg)
}
...
function create_share_btns(a, b) {
    ...
    var d = a.img ? a.img : "", e = "http://service.weibo.com/share/share.php?url=" + encodeURIComponent(c) + "&title=" + encodeURIComponent(a.text) + "&source=" + encodeURIComponent("落网") + "&sourceUrl=" + encodeURIComponent("http://luoo.net") + "&content=utf-8&pic=" + encodeURIComponent(d), f = "http://www.douban.com/share/service?bm=1&image=" + encodeURIComponent(d) + "&href=" + encodeURIComponent(c) + "&updated=&name=" + encodeURIComponent(a.text), g = "http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url=" + encodeURIComponent(c) + "&desc=" + encodeURIComponent(a.text) + "&pics=" + encodeURIComponent(d);
    if ("undefined" == typeof b)
        var h = '<div class="share-btn-wrapper">分享到：<a href="javascript:;" class="btn-action-linkout" data-href="' + e + '" target="_blank" title="分享到微博"><span class="icon-share-weibo"></span></a><a href="javascript:;" class="btn-action-linkout" data-href="' + f + '" target="_blank" title="分享到豆瓣"><span class="icon-share-douban"></span></a><a href="javascript:;" class="btn-action-linkout" data-href="' + g + '" target="_blank" title="分享到QQ空间"><span class="icon-share-qzone"></span></a><a href="javascript:;" class="btn-show-qr" data-href="' + c + '" target="_blank" title="分享到朋友圈"><span class="icon-share-wechat"></span></a></div>';
    else
        var h = '<a href="javascript:;" class="btn-action-linkout" data-href="' + e + '" target="_blank"><span class="icon-share-weibo" title="分享到微博"></span></a><a href="javascript:;" class="btn-action-linkout" data-href="' + f + '" target="_blank" title="分享到豆瓣"><span class="icon-share-douban"></span></a><a href="javascript:;" class="btn-action-linkout" data-href="' + g + '" target="_blank" title="分享到QQ空间"><span class="icon-share-qzone"></span></a><a href="javascript:;" class="btn-show-qr" data-href="' + c + '" target="_blank" title="分享到朋友圈"><span class="icon-share-wechat"></span></a>';
    return h
}
...
function init_player(module_options) {
    ...
    var cssSelector = {currentTime: ".current-time",duration: ".total-time",seekBar: ".loaded",playBar: ".escaped"}, cssSelectorAncestor = {jPlayer: "#luooPlayerContent",cssSelectorAncestor: "#luooPlayerPlaylist"}, luoovolume = $.cookie("luoovolume") ? $.cookie("luoovolume") : .8;
    ...
    var options = {playlistOptions: {autoPlay: autoplay,loopOnPrevious: !0,repeatone: !1},swfPath: $.luoo.root + "/static/thirdparty/jplayer",supplied: "mp3",loop: !0,playbackRate: 2,keyEnabled: !0,cssSelector: cssSelector,wmode: "window",volume: luoovolume};
    return luooPlayer = new jPlayerPlaylist(cssSelectorAncestor, playlist, options), $("#luooPlayerPlaylist").bind($.jPlayer.event.ready, function() {
        ...
        }, 3e4)), "undefined" != typeof window.WebSocket)
            try {
                var wsServer = "ws://muma.luoo.net:8000/", websocket = new WebSocket(wsServer);
                websocket.onopen = function() {
                    websocket.send(JSON.stringify({sessid: $.luoo.res.sessid,playerid: luooPlayer.playerid})), luooPlayer.readyStatus = 1
...
!function(a, b) {
    ...
    var a = 14, b = 8, c = !1, d = function(a) {
        ...
        var b, c, d = [];
        for (16 > a.length && (b = 16 - a.length, d = [b, b, b, b, b, b, b, b, b, b, b, b, b, b, b, b]), c = 0; a.length > c; c++)
            d[c] = a[c];
        return d
    }, g = function(a, b) {
        var c, d, e = "";
        ...
        for (0 === a.length % 16 && (g.push([16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16]), e++), d = 0; g.length > d; d++)
            g[d] = 0 === d ? v(g[d], c) : v(g[d], h[d - 1]), h[d] = p(g[d], b);
        return h
    }, o = function(a, b, c, d) {
        b = w(b);
        ...
        if (c)
            for (b = 0; 4 > b; b++)
                d[4 * b] = L[a[4 * b]] ^ J[a[1 + 4 * b]] ^ K[a[2 + 4 * b]] ^ I[a[3 + 4 * b]], d[1 + 4 * b] = I[a[4 * b]] ^ L[a[1 + 4 * b]] ^ J[a[2 + 4 * b]] ^ K[a[3 + 4 * b]], d[2 + 4 * b] = K[a[4 * b]] ^ I[a[1 + 4 * b]] ^ L[a[2 + 4 * b]] ^ J[a[3 + 4 * b]], d[3 + 4 * b] = J[a[4 * b]] ^ K[a[1 + 4 * b]] ^ I[a[2 + 4 * b]] ^ L[a[3 + 4 * b]];
        else
            for (b = 0; 4 > b; b++)
                d[4 * b] = G[a[4 * b]] ^ H[a[1 + 4 * b]] ^ a[2 + 4 * b] ^ a[3 + 4 * b], d[1 + 4 * b] = a[4 * b] ^ G[a[1 + 4 * b]] ^ H[a[2 + 4 * b]] ^ a[3 + 4 * b], d[2 + 4 * b] = a[4 * b] ^ a[1 + 4 * b] ^ G[a[2 + 4 * b]] ^ H[a[3 + 4 * b]], d[3 + 4 * b] = H[a[4 * b]] ^ a[1 + 4 * b] ^ a[2 + 4 * b] ^ G[a[3 + 4 * b]];
        return d
    }, u = function(a, b, c) {
        var d, e = [];
        for (d = 0; 16 > d; d++)
        ...
        for (d = b; 4 * (a + 1) > d; d++) {
            for (h[d] = [], f = 0; 4 > f; f++)
                i[f] = h[d - 1][f];
            for (0 === d % b ? (i = x(y(i)), i[0] ^= F[d / b - 1]) : b > 6 && 4 === d % b && (i = x(i)), f = 0; 4 > f; f++)
                h[d][f] = h[d - b][f] ^ i[f]
        }
        for (d = 0; a + 1 > d; d++)
            for (j[d] = [], g = 0; 4 > g; g++)
        ...
        var a = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", b = a.split(""), c = function(a) {
            ...
            for (c = 0; e.length > c; c += 3)
                f += b[e[c] >> 2], f += b[(3 & e[c]) << 4 | e[c + 1] >> 4], f += void 0 !== e[c + 1] ? b[(15 & e[c + 1]) << 2 | e[c + 2] >> 6] : "=", f += void 0 !== e[c + 2] ? b[63 & e[c + 2]] : "=";
            ...
            for (c = 0; b.length > c; c += 4)
                e[0] = a.indexOf(b.charAt(c)), e[1] = a.indexOf(b.charAt(c + 1)), e[2] = a.indexOf(b.charAt(c + 2)), e[3] = a.indexOf(b.charAt(c + 3)), f[0] = e[0] << 2 | e[1] >> 4, f[1] = (15 & e[1]) << 4 | e[2] >> 2, f[2] = (3 & e[2]) << 6 | e[3], d.push(f[0], f[1], f[2]);
            return d = d.slice(0, d.length - d.length % 16)
        };
        return "function" == typeof Array.indexOf && (a = b), {encode: c,decode: d}
    }();
    return {size: k,h2a: i,expandKey: w,encryptBlock: p,decryptBlock: q,Decrypt: c,s2a: j,rawEncrypt: n,rawDecrypt: o,dec: N,openSSLKey: m,a2h: h,enc: M,Hash: {MD5: O},Base64: P}
}), function(a, b) {
    ...
    f.platform && (a.jPlayer.platform[f.platform] = !0, a.jPlayer.platform.mobile = !f.tablet, a.jPlayer.platform.tablet = !!f.tablet), a.jPlayer.getDocMode = function() {
        ...
        return a.jPlayer.browser.msie && (document.documentMode ? b = document.documentMode : (b = 5, document.compatMode && "CSS1Compat" === document.compatMode && (b = 7))), b
            ...
            var a, b, c, d = document, e = d.createElement("video"), f = {w3c: ["fullscreenEnabled", "fullscreenElement", "requestFullscreen", "exitFullscreen", "fullscreenchange", "fullscreenerror"],moz: ["mozFullScreenEnabled", "mozFullScreenElement", "mozRequestFullScreen", "mozCancelFullScreen", "mozfullscreenchange", "mozfullscreenerror"],webkit: ["", "webkitCurrentFullScreenElement", "webkitRequestFullScreen", "webkitCancelFullScreen", "webkitfullscreenchange", ""],webkitVideo: ["webkitSupportsFullscreen", "webkitDisplayingFullscreen", "webkitEnterFullscreen", "webkitExitFullscreen", "", ""]}, g = ["w3c", "moz", "webkit", "webkitVideo"];
            for (this.fullscreen = a = {support: {w3c: !!d[f.w3c[0]],moz: !!d[f.moz[0]],webkit: "function" == typeof d[f.webkit[3]],webkitVideo: "function" == typeof e[f.webkitVideo[2]]},used: {}}, b = 0, c = g.length; c > b; b++) {
                var h = g[b];
                if (a.support[h]) {
                    a.spec = h, a.used[h] = !0;
                    break
    ...
    a.jPlayer.keys = function(b) {
        ...
        a(document.documentElement).unbind(c), b && a(document.documentElement).bind(c, g)
    }, a.jPlayer.keys(!0), a.jPlayer.prototype = {count: 0,version: {script: "2.6.0",needFlash: "2.6.0",flash: "unknown"},options: {swfPath: "js",solution: "html, flash",supplied: "mp3",preload: "metadata",volume: .8,muted: !1,remainingDuration: !1,toggleDuration: !1,playbackRate: 1,defaultPlaybackRate: 1,minPlaybackRate: .5,maxPlaybackRate: 4,wmode: "opaque",backgroundColor: "#000000",cssSelectorAncestor: "#jp_container_1",cssSelector: {videoPlay: ".jp-video-play",play: ".jp-play",pause: ".jp-pause",stop: ".jp-stop",seekBar: ".jp-seek-bar",playBar: ".jp-play-bar",mute: ".jp-mute",unmute: ".jp-unmute",volumeBar: ".jp-volume-bar",volumeBarValue: ".jp-volume-bar-value",volumeMax: ".jp-volume-max",playbackRateBar: ".jp-playback-rate-bar",playbackRateBarValue: ".jp-playback-rate-bar-value",currentTime: ".jp-current-time",duration: ".jp-duration",title: ".jp-title",fullScreen: ".jp-full-screen",restoreScreen: ".jp-restore-screen",repeat: ".jp-repeat",repeatOff: ".jp-repeat-off",gui: ".jp-gui",noSolution: ".jp-no-solution"},smoothPlayBar: !1,fullScreen: !1,fullWindow: !1,autohide: {restored: !1,full: !0,fadeIn: 200,fadeOut: 600,hold: 1e3},loop: !1,repeat: function(b) {
            ...
            }), this._resetActive(), this._resetGate(), this._cssSelectorAncestor(this.options.cssSelectorAncestor), this.html.used || this.flash.used ? this.css.jq.noSolution.length && this.css.jq.noSolution.hide() : (this._error({type: a.jPlayer.error.NO_SOLUTION,context: "{solution:'" + this.options.solution + "', supplied:'" + this.options.supplied + "'}",message: a.jPlayer.errorMsg.NO_SOLUTION,hint: a.jPlayer.errorHint.NO_SOLUTION}), this.css.jq.noSolution.length && this.css.jq.noSolution.show()), this.flash.used) {
            ...
            this.css.jq.gui.length && (this.css.jq.gui.stop(!0, !0), clearTimeout(this.internal.autohideId), this.element.unbind(c), this.css.jq.gui.unbind(c), this.status.nativeVideoControls ? this.css.jq.gui.hide() : this.options.fullWindow && this.options.autohide.full || !this.options.fullWindow && this.options.autohide.restored ? (this.element.bind(d, e), 
            this.css.jq.gui.bind(d, e), this.css.jq.gui.hide()) : this.css.jq.gui.show())
        },fullScreen: function() {
    ...
    jPlayerPlaylist = function(b, c, d) {
        var e = this;
        this.current = 0, this.loop = !1, this.shuffled = !1, this.removing = !1, this.cssSelector = a.extend({}, this._cssSelector, b), this.options = a.extend(!0, {keyBindings: {next: {key: 39,fn: function() {
                        e.next()
    ...
    $.luoo = {cfg: {foo: "bar"},tips: [],openedMsg: null,qrcode: null,init: function(a) {
            ...
            async = async === !0 ? !0 : !1, $.ajax({type: "get",url: url,data: data,dataType: "json",async: async}).done(function(json) {
                try {
                    eval("var func = " + cback), func(json, object)
                } catch (e) {
                }
            ...
            return {version: a.match(/(?:firefox|opera|safari|chrome|msie)[\/: ]([\d.]+)/)[1],safari: /version.+safari/.test(a),chrome: /chrome/.test(a),firefox: /firefox/.test(a),ie: /msie/.test(a),opera: /opera/.test(a)}
            ...
            var g = "undefined" == typeof c ? !1 : c, h = "undefined" == typeof d ? "none" : d, e = "undefined" == typeof e ? null : e, f = "undefined" == typeof f ? 410 : f, i = {title: a,content: b,ok: g,cancle: !1,lock: "none" != h,background: h,width: f,close: e};
        ...
        return $(this).each(function() {
            ...
            if (e.posat)
                ...
                var m = "bottom center";
            var n = d.qtip({id: f,content: {text: function(a, b) {
                        if (e.html)
                            return e.html;
                        if (e.remote)
                            $.ajax({url: e.remote,dataType: "json"}).done(function(a) {
    ...
    if ("undefined" == typeof b && (c = this[0], d = 1), "function" == typeof a)
        for (d; e > d; d++)
            this.hasOwnProperty(d) && (c = a(c, this[d], d, this));
    return c
}), "function" != typeof Array.prototype.map && (Array.prototype.map = function(a, b) {
    var c = [];
    if ("function" == typeof a)
        for (var d = 0, e = this.length; e > d; d++)
            c.push(a.call(b, this[d], d, this));
    return c
    ...
    $("body").on("submit", ".form-ajax", function(evt) {
        ...
        return b.data("cback") && (e = b.data("cback")), c ? (b.data("disabled", !0), $.luoo.post($.luoo.root + "/user/like", {id: c,res: $.luoo.res.app[d]}, e, b), !1) : !1
    ...
    $("#backTop").css("left", b2t_left), $("#backTop").click(function(a) {
        ...
        var a = $(this).parents("form");
        return $.trim(a.find('[name="name"]').val()) && $.trim(a.find('[name="password"]').val()) ? void a.submit() : ($(".btn-register-submit").hide(), $(".btn-register-msg").text("请完善未填项目").show(), !1)
