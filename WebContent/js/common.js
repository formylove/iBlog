...
function like_callback(a, b)
{
    ...
    {
        b.data({
            remote : url("login/dialog"), width : 235
        });
        var c = b.tip();
    ...
    {
        1 === a.status ? b.removeClass("icon-fav").addClass("icon-faved").attr("title", b.data("langliked")) : 2 === a.status ? b.removeClass("icon-faved").addClass("icon-fav").attr("title", 
        b.data("langlike")) : a.msg && $.luoo.tip(a.msg);
    }
}
function single_like_callback(a, b)
{
    ...
    {
        1 === a.status ? (c.find(".btn-action-like").removeClass("icon-fav").addClass("icon-faved").attr("title", 
        b.data("langliked")), c.data("fav", 1), $(".PLFav").data("id") == b.data("id") && ($(".PLFav").removeClass("icon-fav").addClass("icon-faved"), 
        $(".PFFav").removeClass("icon-follow-fav").addClass("icon-follow-faved"))) : 2 === a.status ? (c.find(".btn-action-like").removeClass("icon-faved").addClass("icon-fav").attr("title", 
        b.data("langlike")), c.data("fav", 0), $(".PLFav").data("id") == b.data("id") && ($(".PLFav").removeClass("icon-faved").addClass("icon-fav"), 
        $(".PFFav").removeClass("icon-follow-faved").addClass("icon-follow-fav"))) : a.msg && $.luoo.tip(a.msg);
    }
}
...
function check_login(a)
{
    ...
    {
        b.status ? ($("#loggedOutWrapper").hide(), $("#loggedInWrapper").html(b.msg).show(), $("#commentAvatarHolder").attr("href", 
        $.luoo.root + "/user/" + b.data.uid), $("#commentAvatarHolder img").attr("src", b.data.user_avatar), 
        $("#commentForm").data("login", 1), $("#lnActiveTip").tip("", !1)) : "undefined" != typeof a ? ($("#loggedOutWrapper").hide(), 
        $("#loggedInWrapper").html(b.msg).show(), $("#commentForm").data("login", 0)) : ($("#loggedOutWrapper").show(), 
        $("#loggedInWrapper").html("").hide(), $("#commentAvatarHolder").attr("href", "javascript:;"), 
        $("#commentAvatarHolder img").attr("src", $.luoo.url_static + "/img/avatar.gif"), $("#commentForm").data("login", 
        0))
    })
}
function head_register_cback(a, b)
{
    b.data("disabled", 0), a.status ? (b.find(".btn-register-submit").hide(), b.find(".btn-register-msg").text(a.msg).show(), 
    setTimeout(function ()
    {
        check_login(a.uid)
...
{
    if (!a.app || !a.id || !a.text) {
        return!1;
    }
    if ("vol" == a.app) {
        var c = url("music/" + parseInt(a.id));
    }
    else if ("musician" == a.app) {
        var c = url("musician/") + "?mid=" + a.id;
    }
    else {
        var c = url(a.app + "/" + parseInt(a.id));
    }
    var d = a.img ? a.img : "", e = "http://service.weibo.com/share/share.php?url=" + encodeURIComponent(c) + "&title=" + encodeURIComponent(a.text) + "&source=" + encodeURIComponent("落网") + "&sourceUrl=" + encodeURIComponent("http://luoo.net") + "&content=utf-8&pic=" + encodeURIComponent(d), 
    ...
    {
        var h = '<div class="share-btn-wrapper">分享到：<a href="javascript:;" class="btn-action-linkout" data-href="' + e + '" target="_blank" title="分享到微博"><span class="icon-share-weibo"></span></a><a href="javascript:;" class="btn-action-linkout" data-href="' + f + '" target="_blank" title="分享到豆瓣"><span class="icon-share-douban"></span></a><a href="javascript:;" class="btn-action-linkout" data-href="' + g + '" target="_blank" title="分享到QQ空间"><span class="icon-share-qzone"></span></a></div>';
    }
    else
    {
        var h = '<a href="javascript:;" class="btn-action-linkout" data-href="' + e + '" target="_blank"><span class="icon-share-weibo" title="分享到微博"></span></a><a href="javascript:;" class="btn-action-linkout" data-href="' + f + '" target="_blank" title="分享到豆瓣"><span class="icon-share-douban"></span></a><a href="javascript:;" class="btn-action-linkout" data-href="' + g + '" target="_blank" title="分享到QQ空间"><span class="icon-share-qzone"></span></a>';
    }
    return h
}
function feedback_cback(a, b)
{
    b.data("disabled", 0), a.status ? ($("#frmFeedback").animate({
        height : 75
    },
    300, function ()
    {
...
function update_playlist_btn_status()
{
    $(".track-item").each(function (a, b)
    {
        ...
        {
            var c = $(b);
            "play" == c.data("status") ? (c.find(".duration, .progress, .player-btns").show(), c.find(".icon-status-pause").css("display", 
            "inline-block"), c.find(".icon-status-play").hide(), c.find(".icon-info, .icon-fav, .icon-faved, .icon-share, .icon-trash").css("visibility", 
            "visible"), c.find(".player-ctl").removeClass("icon-detail-play").addClass("icon-detail-pause")) : "pause" == c.data("status") ? (c.find(".duration, .progress, .player-btns").show(), 
            c.find(".icon-status-play").css("display", "inline-block"), c.find(".icon-status-pause").hide(), 
            c.find(".icon-info, .icon-fav, .icon-faved, .icon-share, .icon-trash").css("visibility", "visible"), 
            c.find(".player-ctl").removeClass("icon-detail-pause").addClass("icon-detail-play")) : (c.find(".icon-status-pause, .icon-status-play, .duration, .progress, .player-btns").hide(), 
            c.find(".icon-info, .icon-fav, .icon-faved, .icon-share, .icon-trash").css("visibility", "hidden")), 
            $(".icon-faved").css("visibility", "visible")
        }
    })
}
function show_track_detail(a)
{
    0 == $("#trackDetailWrapper" + a).find(".lyric-content").html() && $.luoo.get(url("single/lyric/" + a), 
    {}, function (a, b)
    {
...
function init_player(module_options)
{
    ...
    function ()
    {
        return $(this).siblings(".track-detail-wrapper").is($(":visible")) || "play" == $(this).parents(".track-item").data("status") ?!1 : ($(this).find(".icon-info, .icon-fav,.icon-share, .icon-trash").css("visibility", 
        "hidden"), void $(".icon-faved").css("visibility", "visible"))
    });
    var cssSelector = 
    {
        currentTime : ".current-time", duration : ".total-time", seekBar : ".loaded", playBar : ".escaped"
    },
    cssSelectorAncestor = {
        jPlayer : "#luooPlayerContent", cssSelectorAncestor : "#luooPlayerPlaylist"
    },
    luoovolume = $.cookie("luoovolume") ? $.cookie("luoovolume") : .8;
    if ("undefined" != typeof module_options && "undefined" != typeof module_options.autoplay) {
        var autoplay = 0 == module_options.autoplay ?!1 :!0;
    }
    else {
        var autoplay = $.luoo.cfg.auto_play;
    }
    var options = 
    {
        playlistOptions : {
            autoPlay : autoplay, loopOnPrevious :!0, repeatone :!1
        },
        swfPath : $.luoo.root + "/static/thirdparty/jplayer", supplied : "mp3", loop :!0, playbackRate : 2, 
        keyEnabled :!0, cssSelector : cssSelector, wmode : "window", volume : luoovolume
    };
    return luooPlayer = new jPlayerPlaylist(cssSelectorAncestor, playlist, options), $("#luooPlayerPlaylist").bind($.jPlayer.event.ready, 
    function ()
    {
    ...
    }), $("#luooPlayerPlaylist").bind($.jPlayer.event.play, function ()
    {
        ...
        if ($(".track-item").data("status", "ready"), $track.data("status", "play"), update_playlist_btn_status(), 
        "undefined" != typeof module_options && "undefined" != typeof module_options.updateTitle && 0 != module_options.updateTitle && $("title").text(luooPlayer.playlist[luooPlayer.current].title), 
        "undefined" != typeof module_options && "undefined" != typeof module_options.playCback && eval(module_options.playCback + "()"), 
        parseInt($.luoo.res.uid) > 0 && (clearTimeout(log_int), log_int = setTimeout(function ()
        {
        ...
        }, 3e4)), "undefined" != typeof window.WebSocket) try
        {
            ...
            websocket.onopen = function ()
            {
                websocket.send(JSON.stringify({
                    sessid : $.luoo.res.sessid, playerid : luooPlayer.playerid
            ...
            websocket.onerror = function () {}, websocket.onclose = function () {}
        }
        catch (e) {
    ...
    {
        "undefined" != typeof a.jPlayer.options.volume && a.jPlayer.options.volume > 0 && $.cookie("luoovolume", 
        a.jPlayer.options.volume)
    }), $(".icon-info").click(function ()
    {
        var a = $("#track" + $(this).data("sid"));
        a.find(".track-detail-wrapper").is($(":visible")) ? a.find(".track-detail-wrapper").hide() : show_track_detail($(this).data("sid"), 
        $(this).data("sname"))
    }), $(".btn-play, .player-ctl").click(function ()
    {
        var a = $(this).parents(".track-item"), b = a.index();
        "play" == a.data("status") ? (a.data("status", "pause"), luooPlayer.pause()) : luooPlayer.current == b ? ($(this).data("status", 
        "play"), luooPlayer.play()) : ($(this).data("status", "play"), luooPlayer.play(b))
    }), !0
}
function add_lyric_cback(a, b)
{
    b.data("disabled", 0), 1 == a.status ? (a.data && ($("#trackDetailWrapper" + a.data).find(".lyric-content").html(""), 
    show_track_detail(a.data)), $.luoo.close_msg()) : (b.find(".btn-positive").hide(), b.find(".btn-not-ready").text(a.msg).show())
}
function single_report_cback(a, b)
{
    b.data("disabled", 0), 1 == a.status ? $("#singleReportWrapper").animate({
        height : 0
    },
    300, function ()
    {
...
{
    b.data("disabled", 0), a.status ? ($("#frmMail").animate({
        height : 75
    },
    300, function ()
    {
...
(this, function ()
{
    ...
    {
        var b, c, d = [];
        for (16 > a.length && (b = 16 - a.length, d = [b, b, b, b, b, b, b, b, b, b, b, b, b, b, b, b]), 
        c = 0;
        a.length > c;
        c++) d[c] = a[c];
        return d;
    ...
    l = function (a)
    {
        var b, c = [];
        for (b = 0; a > b; b++) {
            c = c.concat(Math.floor(256 * Math.random()));
        }
        return c;
    },
    m = function (c, d)
    {
        ...
        for (i[0] = O(k), j = i[0], e = 1; f > e; e++) {
            i[e] = O(i[e - 1].concat(k)), j = j.concat(i[e]);
        }
        return g = j.slice(0, 4 * b), h = j.slice(4 * b, 4 * b + 16), 
        {
            key : g, iv : h
        }
    },
    n = function (a, b, c)
    {
        ...
        for (d = 0; e > d; d++) {
            g[d] = f(a.slice(16 * d, 16 * d + 16));
        }
        for (0 === a.length % 16 && (g.push([16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 
        16]), e++), d = 0;
        g.length > d;
        d++) g[d] = 0 === d ? v(g[d], c) : v(g[d], h[d - 1]), h[d] = p(g[d], b);
        return h;
    },
    o = function (a, b, c, d)
    {
        ...
        for (f = i.length - 1; f >= 0; f--) {
            j[f] = q(i[f], b), j[f] = 0 === f ? v(j[f], c) : v(j[f], i[f - 1]);
        }
        for (f = 0; h - 1 > f; f++) {
            k += g(j[f]);
        }
    ...
    p = function (b, d)
    {
        ...
        var e, f = u(b, d, 0);
        for (e = 1; a + 1 > e; e++) {
            f = r(f), f = s(f), a > e && (f = t(f)), f = u(f, d, e);
        }
        return f;
    },
    q = function (b, d)
    {
        ...
        var e, f = u(b, d, a);
        for (e = a - 1; e > -1; e--) {
            f = s(f), f = r(f), f = u(f, d, e), e > 0 && (f = t(f));
        }
        return f;
    },
    r = function (a)
    ...
    s = function (a)
    {
        var b, d = [], e = c ? [0, 13, 10, 7, 4, 1, 14, 11, 8, 5, 2, 15, 12, 9, 6, 3] : [0, 5, 10, 15, 
        4, 9, 14, 3, 8, 13, 2, 7, 12, 1, 6, 11];
        for (b = 0; 16 > b; b++) {
            d[b] = a[e[b]];
        }
        return d;
    ...
    t = function (a)
    {
        ...
        if (c)
        {
            for (b = 0; 4 > b; b++)
            {
                d[4 * b] = L[a[4 * b]]^J[a[1 + 4 * b]]^K[a[2 + 4 * b]]^I[a[3 + 4 * b]], d[1 + 4 * b] = I[a[4 * b]]^L[a[1 + 4 * b]]^J[a[2 + 4 * b]]^K[a[3 + 4 * b]], 
                d[2 + 4 * b] = K[a[4 * b]]^I[a[1 + 4 * b]]^L[a[2 + 4 * b]]^J[a[3 + 4 * b]], d[3 + 4 * b] = J[a[4 * b]]^K[a[1 + 4 * b]]^I[a[2 + 4 * b]]^L[a[3 + 4 * b]];
            }
        }
        else
        {
            for (b = 0; 4 > b; b++)
            {
                d[4 * b] = G[a[4 * b]]^H[a[1 + 4 * b]]^a[2 + 4 * b]^a[3 + 4 * b], d[1 + 4 * b] = a[4 * b]^G[a[1 + 4 * b]]^H[a[2 + 4 * b]]^a[3 + 4 * b], 
                d[2 + 4 * b] = a[4 * b]^a[1 + 4 * b]^G[a[2 + 4 * b]]^H[a[3 + 4 * b]], d[3 + 4 * b] = H[a[4 * b]]^a[1 + 4 * b]^a[2 + 4 * b]^G[a[3 + 4 * b]];
            }
        }
        return d;
    },
    ...
    w = function (c)
    {
        var d, e, f, g, h = [], i = [], j = [];
        for (d = 0; b > d; d++) {
            e = [c[4 * d], c[4 * d + 1], c[4 * d + 2], c[4 * d + 3]], h[d] = e;
        }
        for (d = b; 4 * (a + 1) > d; d++)
        {
            for (h[d] = [], f = 0; 4 > f; f++) {
            ...
            for (0 === d % b ? (i = x(y(i)), i[0]^ = F[d / b - 1]) : b > 6 && 4 === d % b && (i = x(i)), 
            f = 0;
            4 > f;
            f++) h[d][f] = h[d - b][f]^i[f]
        }
    ...
    2), E = A(D), F = z("01020408102040801b366cd8ab4d9a2f5ebc63c697356ad4b37dfaefc591", 2), G = C(2), 
    H = C(3), I = C(9), J = C(11), K = C(13), L = C(14), M = function (a, b, c)
    {
        var d, e = l(8), f = m(j(b, c), e), g = f.key, h = f.iv, i = [[83, 97, 108, 116, 101, 100, 95, 
        95].concat(e)];
    ...
    O = function (a)
    {
        ...
        {
            var c, d, e, f, g;
            return e = 2147483648 & a, f = 2147483648 & b, c = 1073741824 & a, d = 1073741824 & b, g = (1073741823 & a) + (1073741823 & b), 
        ...
        function l(a)
        {
            for (var b, c = a.length, d = c + 8, e = (d - d % 64) / 64, f = 16 * (e + 1), g = [], h = 0, 
            i = 0;
            c > i;
            ) b = (i - i % 4) / 4, h = 8 * (i % 4), g[b] = g[b] | a[i] << h, i++;
            return b = (i - i % 4) / 4, h = 8 * (i % 4), g[b] = g[b] | 128 << h, g[f - 2] = c << 3, g[f - 1] = c >>> 29, 
            g
        }
        function m(a)
        {
        ...
        8);
        for (w = l(a), s = x[0], t = x[1], u = x[2], v = x[3], n = 0; w.length > n; n += 16)
        {
            o = s, p = t, q = u, r = v, s = h(s, t, u, v, w[n + 0], 7, x[4]), v = h(v, s, t, u, w[n + 1], 
            12, x[5]), u = h(u, v, s, t, w[n + 2], 17, x[6]), t = h(t, u, v, s, w[n + 3], 22, x[7]), s = h(s, 
            t, u, v, w[n + 4], 7, x[8]), v = h(v, s, t, u, w[n + 5], 12, x[9]), u = h(u, v, s, t, w[n + 6], 
            17, x[10]), t = h(t, u, v, s, w[n + 7], 22, x[11]), s = h(s, t, u, v, w[n + 8], 7, x[12]), 
            v = h(v, s, t, u, w[n + 9], 12, x[13]), u = h(u, v, s, t, w[n + 10], 17, x[14]), t = h(t, 
            u, v, s, w[n + 11], 22, x[15]), s = h(s, t, u, v, w[n + 12], 7, x[16]), v = h(v, s, t, u, 
            w[n + 13], 12, x[17]), u = h(u, v, s, t, w[n + 14], 17, x[18]), t = h(t, u, v, s, w[n + 15], 
            22, x[19]), s = i(s, t, u, v, w[n + 1], 5, x[20]), v = i(v, s, t, u, w[n + 6], 9, x[21]), 
            u = i(u, v, s, t, w[n + 11], 14, x[22]), t = i(t, u, v, s, w[n + 0], 20, x[23]), s = i(s, 
            t, u, v, w[n + 5], 5, x[24]), v = i(v, s, t, u, w[n + 10], 9, x[25]), u = i(u, v, s, t, w[n + 15], 
            14, x[26]), t = i(t, u, v, s, w[n + 4], 20, x[27]), s = i(s, t, u, v, w[n + 9], 5, x[28]), 
            v = i(v, s, t, u, w[n + 14], 9, x[29]), u = i(u, v, s, t, w[n + 3], 14, x[30]), t = i(t, u, 
            v, s, w[n + 8], 20, x[31]), s = i(s, t, u, v, w[n + 13], 5, x[32]), v = i(v, s, t, u, w[n + 2], 
            9, x[33]), u = i(u, v, s, t, w[n + 7], 14, x[34]), t = i(t, u, v, s, w[n + 12], 20, x[35]), 
            s = j(s, t, u, v, w[n + 5], 4, x[36]), v = j(v, s, t, u, w[n + 8], 11, x[37]), u = j(u, v, 
            s, t, w[n + 11], 16, x[38]), t = j(t, u, v, s, w[n + 14], 23, x[39]), s = j(s, t, u, v, w[n + 1], 
            4, x[40]), v = j(v, s, t, u, w[n + 4], 11, x[41]), u = j(u, v, s, t, w[n + 7], 16, x[42]), 
            t = j(t, u, v, s, w[n + 10], 23, x[43]), s = j(s, t, u, v, w[n + 13], 4, x[44]), v = j(v, 
            s, t, u, w[n + 0], 11, x[45]), u = j(u, v, s, t, w[n + 3], 16, x[46]), t = j(t, u, v, s, w[n + 6], 
            23, x[47]), s = j(s, t, u, v, w[n + 9], 4, x[48]), v = j(v, s, t, u, w[n + 12], 11, x[49]), 
            u = j(u, v, s, t, w[n + 15], 16, x[50]), t = j(t, u, v, s, w[n + 2], 23, x[51]), s = k(s, 
            t, u, v, w[n + 0], 6, x[52]), v = k(v, s, t, u, w[n + 7], 10, x[53]), u = k(u, v, s, t, w[n + 14], 
            15, x[54]), t = k(t, u, v, s, w[n + 5], 21, x[55]), s = k(s, t, u, v, w[n + 12], 6, x[56]), 
            v = k(v, s, t, u, w[n + 3], 10, x[57]), u = k(u, v, s, t, w[n + 10], 15, x[58]), t = k(t, 
            u, v, s, w[n + 1], 21, x[59]), s = k(s, t, u, v, w[n + 8], 6, x[60]), v = k(v, s, t, u, w[n + 15], 
            10, x[61]), u = k(u, v, s, t, w[n + 6], 15, x[62]), t = k(t, u, v, s, w[n + 13], 21, x[63]), 
            s = k(s, t, u, v, w[n + 4], 6, x[64]), v = k(v, s, t, u, w[n + 11], 10, x[65]), u = k(u, v, 
            s, t, w[n + 2], 15, x[66]), t = k(t, u, v, s, w[n + 9], 21, x[67]), s = c(s, o), t = c(t, 
            p), u = c(u, q), v = c(v, r);
        }
    ...
    P = function ()
    {
        ...
        {
            var c, d, e = [], f = "";
            for (Math.floor(16 * a.length / 3), c = 0; 16 * a.length > c; c++) {
                e.push(a[Math.floor(c  / 16)][c % 16]);
            }
            for (c = 0; e.length > c; c += 3)
            {
                f += b[e[c] >> 2], f += b[(3 & e[c]) << 4 | e[c + 1] >> 4], f += void 0 !== e[c + 1] ? b[(15 & e[c + 1]) << 2 | e[c + 2] >> 6] : "=", 
                f += void 0 !== e[c + 2] ? b[63 & e[c + 2]] : "=";
            }
            for (d = f.slice(0, 64) + "\n", c = 1; Math.ceil(f.length / 64) > c; c++) {
                d += f.slice(64 * c, 64 * c + 64) + (Math.ceil(f.length  / 64) === c + 1 ? "" : "\n");
            }
            return d;
        },
        d = function (b)
        {
            ...
            {
                e[0] = a.indexOf(b.charAt(c)), e[1] = a.indexOf(b.charAt(c + 1)), e[2] = a.indexOf(b.charAt(c + 2)), 
                e[3] = a.indexOf(b.charAt(c + 3)), f[0] = e[0] << 2 | e[1] >> 4, f[1] = (15 & e[1]) << 4 | e[2] >> 2, 
                f[2] = (3 & e[2]) << 6 | e[3], d.push(f[0], f[1], f[2]);
            }
    ...
    return {
        size : k, h2a : i, expandKey : w, encryptBlock : p, decryptBlock : q, Decrypt : c, s2a : j, rawEncrypt : n, 
        rawDecrypt : o, dec : N, openSSLKey : m, a2h : h, enc : M, Hash : {
            MD5 : O
        },
        Base64 : P
    }
...
(this, function (a, b)
{
    ...
    "function" != typeof a.fn.stop && (a.fn.stop = function () {}), a.jPlayer.emulateMethods = "load play pause", 
    ...
    a.jPlayer.event = {}, a.each(["ready", "setmedia", "flashreset", "resize", "repeat", "click", "error", 
    "warning", "loadstart", "progress", "suspend", "abort", "emptied", "stalled", "play", "pause", "loadedmetadata", 
    "loadeddata", "waiting", "playing", "canplay", "canplaythrough", "seeking", "seeked", "timeupdate", 
    "ended", "ratechange", "durationchange", "volumechange"], function ()
    {
        a.jPlayer.event[this] = "jPlayer_" + this;
    }), a.jPlayer.htmlEvent = ["loadstart", "abort", "emptied", "stalled", "loadedmetadata", "loadeddata", 
    "canplay", "canplaythrough"], a.jPlayer.pause = function ()
    {
    ...
    {
        showHour :!1, showMin :!0, showSec :!0, padHour :!1, padMin :!0, padSec :!0, sepHour : ":", sepMin : ":", 
        sepSec : ""
    };
    var c = function ()
    {
    ...
    c.prototype = 
    {
        ...
        time : function (a)
        {
            ...
            var b = new Date(1e3 * a), c = b.getUTCHours(), d = this.options.timeFormat.showHour ? b.getUTCMinutes() : b.getUTCMinutes() + 60 * c, 
            e = this.options.timeFormat.showMin ? b.getUTCSeconds() : b.getUTCSeconds() + 60 * d, f = this.options.timeFormat.padHour && 10 > c ? "0" + c : c, 
            g = this.options.timeFormat.padMin && 10 > d ? "0" + d : d, h = this.options.timeFormat.padSec && 10 > e ? "0" + e : e, 
            i = "";
            return i += this.options.timeFormat.showHour ? f + this.options.timeFormat.sepHour : "", i += this.options.timeFormat.showMin ? g + this.options.timeFormat.sepMin : "", 
    ...
    a.jPlayer.uaBrowser = function (a)
    {
        ...
        e = /(msie) ([\w.]+)/, f = /(mozilla)(?:.*? rv:([\w.]+))?/, g = c.exec(b) || d.exec(b) || e.exec(b) || b.indexOf("compatible") < 0 && f.exec(b) || [];
        return {
            browser : g[1] || "", version : g[2] || "0"
        }
    },
    a.jPlayer.uaPlatform = function (a)
    {
        var b = a.toLowerCase(), c = /(ipad|iphone|ipod|android|blackberry|playbook|windows ce|webos)/, 
        d = /(ipad|playbook)/, e = /(android)/, f = /(mobile)/, g = c.exec(b) || [], h = d.exec(b) || !f.exec(b) && e.exec(b) || [];
    ...
    a.jPlayer.getDocMode = function ()
    {
        ...
        document.compatMode && "CSS1Compat" === document.compatMode && (b = 7))), b;
    },
    a.jPlayer.browser.documentMode = a.jPlayer.getDocMode(), a.jPlayer.nativeFeatures = 
    {
        init : function ()
        {
            ...
            {
                w3c : ["fullscreenEnabled", "fullscreenElement", "requestFullscreen", "exitFullscreen", 
                "fullscreenchange", "fullscreenerror"], moz : ["mozFullScreenEnabled", "mozFullScreenElement", 
                "mozRequestFullScreen", "mozCancelFullScreen", "mozfullscreenchange", "mozfullscreenerror"], 
                webkit : ["", "webkitCurrentFullScreenElement", "webkitRequestFullScreen", "webkitCancelFullScreen", 
                "webkitfullscreenchange", ""], webkitVideo : ["webkitSupportsFullscreen", "webkitDisplayingFullscreen", 
            ...
            for (this.fullscreen = a = 
            {
                support : 
                {
                    w3c :!!d[f.w3c[0]], moz :!!d[f.moz[0]], webkit : "function" == typeof d[f.webkit[3]], 
            ...
            if (a.spec)
            {
                ...
                a.event = {
                    fullscreenchange : i[4], fullscreenerror : i[5]
                }
            }
            else a.api = 
            {
    ...
    {
        count : 0, version : {
            script : "2.6.0", needFlash : "2.6.0", flash : "unknown"
        },
        options : 
        {
            swfPath : "js", solution : "html, flash", supplied : "mp3", preload : "metadata", volume : .8, 
            muted :!1, remainingDuration :!1, toggleDuration :!1, playbackRate : 1, defaultPlaybackRate : 1, 
            minPlaybackRate : .5, maxPlaybackRate : 4, wmode : "opaque", backgroundColor : "#000000", 
            cssSelectorAncestor : "#jp_container_1", cssSelector : 
            {
                videoPlay : ".jp-video-play", play : ".jp-play", pause : ".jp-pause", stop : ".jp-stop", 
                seekBar : ".jp-seek-bar", playBar : ".jp-play-bar", mute : ".jp-mute", unmute : ".jp-unmute", 
                volumeBar : ".jp-volume-bar", volumeBarValue : ".jp-volume-bar-value", volumeMax : ".jp-volume-max", 
                playbackRateBar : ".jp-playback-rate-bar", playbackRateBarValue : ".jp-playback-rate-bar-value", 
                currentTime : ".jp-current-time", duration : ".jp-duration", title : ".jp-title", fullScreen : ".jp-full-screen", 
                restoreScreen : ".jp-restore-screen", repeat : ".jp-repeat", repeatOff : ".jp-repeat-off", 
                gui : ".jp-gui", noSolution : ".jp-no-solution"
            },
            smoothPlayBar :!1, fullScreen :!1, fullWindow :!1, autohide : {
            ...
            nativeVideoControls : {}, noFullWindow : 
            {
                ...
                android_phone : /android.*?mobile/, blackberry : /blackberry/, windows_ce : /windows ce/, 
                iemobile : /iemobile/, webos : /webos/
            },
            noVolume : 
            {
                ipad : /ipad/, iphone : /iphone/, ipod : /ipod/, android_pad : /android(?!.*?mobile)/, 
                android_phone : /android.*?mobile/, blackberry : /blackberry/, windows_ce : /windows ce/, 
                iemobile : /iemobile/, webos : /webos/, playbook : /playbook/
            },
            ...
            verticalVolume :!1, verticalPlaybackRate :!1, globalVolume :!1, idPrefix : "jp", noConflict : "jQuery", 
            emulateHtml :!1, consoleAlerts :!0, errorAlerts :!1, warningAlerts :!1
        },
        optionsAudio : 
        {
            size : {
        ...
        instances : {}, status : 
        {
            src : "", media : {}, paused :!0, format : {}, formatType : "", waitForPlay :!0, waitForLoad :!0, 
            srcSet :!1, video :!1, seekPercent : 0, currentPercentRelative : 0, currentPercentAbsolute : 0, 
            currentTime : 0, duration : 0, remaining : 0, videoWidth : 0, videoHeight : 0, readyState : 0, 
        ...
        {
            mp3 : {
                codec : 'audio/mpeg; codecs="mp3"', flashCanPlay :!0, media : "audio"
            },
            m4a : {
            ...
            m3u8a : 
            {
                codec : 'application/vnd.apple.mpegurl; codecs="mp4a.40.2"', flashCanPlay :!1, media : "audio"
            },
            m3ua : {
                codec : "audio/mpegurl", flashCanPlay :!1, media : "audio"
            },
            oga : {
                codec : 'audio/ogg; codecs="vorbis, opus"', flashCanPlay :!1, media : "audio"
            },
            flac : {
                codec : "audio/x-flac", flashCanPlay :!1, media : "audio"
            },
            wav : {
            ...
            m3u8v : 
            {
                codec : 'application/vnd.apple.mpegurl; codecs="avc1.42E01E, mp4a.40.2"', flashCanPlay :!1, 
                media : "video"
            },
            m3uv : {
                codec : "audio/mpegurl", flashCanPlay :!1, media : "video"
            },
            ogv : {
        ...
        {
            var c = this;
            if (this.element.empty(), this.status = a.extend({}, this.status), this.internal = a.extend({},
            this.internal), this.options.timeFormat = a.extend({}, a.jPlayer.timeFormat, this.options.timeFormat), 
            this.internal.cmdsIgnored = a.jPlayer.platform.ipad || a.jPlayer.platform.iphone || a.jPlayer.platform.ipod, 
            this.internal.domNode = this.element.get(0), this.options.keyEnabled && !a.jPlayer.focus && (a.jPlayer.focus = this), 
            this.androidFix = {
                setMedia :!1, play :!1, pause :!1, time : 0 / 0
            },
            a.jPlayer.platform.android && (this.options.preload = "auto" !== this.options.preload ? "metadata" : "auto"), 
            this.formats = [], this.solutions = [], this.require = {}, this.htmlElement = {},
            this.html = {}, this.html.audio = {}, this.html.video = {}, this.flash = {},
            this.css = {}, this.css.cs = {}, this.css.jq = {}, this.ancestorJq = [], this.options.volume = this._limitValue(this.options.volume, 
            0, 1), a.each(this.options.supplied.toLowerCase().split(","), function (b, d)
            {
            ...
            {
                id : this.options.idPrefix + "_flash_" + this.count, jq : b, swf : this.options.swfPath + (".swf" !== this.options.swfPath.toLowerCase().slice(-4) ? (this.options.swfPath && "/" !== this.options.swfPath.slice(-1) ? "/" : "") + "Jplayer.swf" : "")
            ...
            {}, this.optionsAudio, this.options), this._setSize(), this.status.nativeVideoControls = this._uaBlocklist(this.options.nativeVideoControls), 
            this.status.noFullWindow = this._uaBlocklist(this.options.noFullWindow), this.status.noVolume = this._uaBlocklist(this.options.noVolume), 
            ...
            this.flash.available = this._checkForFlash(10.1), this.html.canPlay = {},
            this.flash.canPlay = {}, a.each(this.formats, function (a, b)
            {
            ...
            {
                type : a.jPlayer.error.NO_SOLUTION, context : "{solution:'" + this.options.solution + "', supplied:'" + this.options.supplied + "'}", 
                message : a.jPlayer.errorMsg.NO_SOLUTION, hint : a.jPlayer.errorHint.NO_SOLUTION
            }), this.css.jq.noSolution.length && this.css.jq.noSolution.show()), this.flash.used)
            {
                ...
                else
                {
                    ...
                    d = document.createElement("object"), d.setAttribute("id", this.internal.flash.id), 
                    d.setAttribute("name", this.internal.flash.id), d.setAttribute("data", this.internal.flash.swf), 
                    d.setAttribute("type", "application/x-shockwave-flash"), d.setAttribute("width", "1"), 
                    d.setAttribute("height", "1"), d.setAttribute("tabindex", "-1"), i(d, "flashvars", 
                    e), i(d, "allowscriptaccess", "always"), i(d, "bgcolor", this.options.backgroundColor), 
            ...
            this._updatePlaybackRate(), this.html.used && (this.html.audio.available && (this._addHtmlEventListeners(this.htmlElement.audio, 
            this.html.audio), this.element.append(this.htmlElement.audio), this.internal.audio.jq = a("#" + this.internal.audio.id)), 
            this.html.video.available && (this._addHtmlEventListeners(this.htmlElement.video, this.html.video), 
            this.element.append(this.htmlElement.video), this.internal.video.jq = a("#" + this.internal.video.id), 
            ...
            }, 100), this._updateNativeVideoControls(), this.css.jq.videoPlay.length && this.css.jq.videoPlay.hide(), 
            a.jPlayer.prototype.count++
        },
        destroy : function ()
        {
            this.clearMedia(), this._removeUiClass(), this.css.jq.currentTime.length && this.css.jq.currentTime.text(""), 
            this.css.jq.duration.length && this.css.jq.duration.text(""), a.each(this.css.jq, function (a, 
            b) {
                b.length && b.unbind(".jPlayer")
            }), this.internal.poster.jq.unbind(".jPlayer"), this.internal.video.jq && this.internal.video.jq.unbind(".jPlayer"), 
            this._fullscreenRemoveEventListeners(), this === a.jPlayer.focus && (a.jPlayer.focus = null), 
        ...
        {
            var d = this;
            b.preload = this.options.preload, b.muted = this.options.muted, b.volume = this.options.volume, 
            this.status.playbackRateEnabled && (b.defaultPlaybackRate = this.options.defaultPlaybackRate, 
            b.playbackRate = this.options.playbackRate), b.addEventListener("progress", function ()
            {
                c.gate && (d.internal.cmdsIgnored && this.readyState > 0 && (d.internal.cmdsIgnored = !1), 
                d.androidFix.setMedia = !1, d.androidFix.play && (d.androidFix.play = !1, d.play(d.androidFix.time)), 
                d.androidFix.pause && (d.androidFix.pause = !1, d.pause(d.androidFix.time)), d._getHtmlStatus(b), 
            ...
            {
                c.gate && (d.options.volume = b.volume, d.options.muted = b.muted, d._updateMute(), d._updateVolume(), 
                d._trigger(a.jPlayer.event.volumechange));
            },
            !1), b.addEventListener("ratechange", function ()
            {
                c.gate && (d.options.defaultPlaybackRate = b.defaultPlaybackRate, d.options.playbackRate = b.playbackRate, 
                d._updatePlaybackRate(), d._trigger(a.jPlayer.event.ratechange));
            },
            ...
            {
                c.gate && (a.jPlayer.browser.webkit || (d.htmlElement.media.currentTime = 0), d.htmlElement.media.pause(), 
                d._updateButtons(!1), d._getHtmlStatus(b, !0), d._updateInterface(), d._trigger(a.jPlayer.event.ended));
            },
            !1), b.addEventListener("error", function ()
            {
                ...
                {
                    type : a.jPlayer.error.URL, context : d.status.src, message : a.jPlayer.errorMsg.URL, 
        ...
        {
            var c = 0, d = 0, e = 0, f = 0;
            isFinite(a.duration) && (this.status.duration = a.duration), c = a.currentTime, d = this.status.duration > 0 ? 100 * c / this.status.duration : 0, 
            ...
            f = d), b && (c = 0, f = 0, d = 0), this.status.seekPercent = e, this.status.currentPercentRelative = f, 
            this.status.currentPercentAbsolute = d, this.status.currentTime = c, this.status.remaining = this.status.duration - this.status.currentTime, 
            this.status.videoWidth = a.videoWidth, this.status.videoHeight = a.videoHeight, this.status.readyState = a.readyState, 
            this.status.networkState = a.networkState, this.status.playbackRate = a.playbackRate, this.status.ended = a.ended;
        },
        ...
        {
            var e = a.Event(b);
            e.jPlayer = {}, e.jPlayer.version = a.extend({}, this.version), e.jPlayer.options = a.extend(!0, 
            {}, this.options), e.jPlayer.status = a.extend(!0, {}, this.status), e.jPlayer.html = a.extend(!0, 
            {}, this.html), e.jPlayer.flash = a.extend(!0, {}, this.flash), c && (e.jPlayer.error = a.extend({},
        ...
        jPlayerFlashEvent : function (b, c)
        {
            if (b === a.jPlayer.event.ready)
            {
                if (this.internal.ready) 
                {
                    if (this.flash.gate) 
                    {
                        if (this.status.srcSet) 
                        {
                            ...
                            this.setMedia(this.status.media), this.volumeWorker(this.options.volume), 
                ...
                else
                {
                    ...
                    {
                        type : a.jPlayer.error.VERSION, context : this.version.flash, message : a.jPlayer.errorMsg.VERSION + this.version.flash, 
                ...
                if (this.flash.gate)
                {
                    switch (b) 
                    {
                        ...
                        case a.jPlayer.event.error:
                            ...
                            {
                                type : a.jPlayer.error.URL, context : c.src, message : a.jPlayer.errorMsg.URL, 
                                hint : a.jPlayer.errorHint.URL 
                            });
                            break;
        ...
        _getFlashStatus : function (a)
        {
            ...
            this.status.duration = a.duration, this.status.remaining = a.duration - a.currentTime, this.status.videoWidth = a.videoWidth, 
            this.status.videoHeight = a.videoHeight, this.status.readyState = 4, this.status.networkState = 0, 
            this.status.playbackRate = 1, this.status.ended = !1;
        },
        _updateButtons : function (a)
        {
            a === b ? a = !this.status.paused : this.status.paused = !a, this.css.jq.play.length && this.css.jq.pause.length && (a ? (this.css.jq.play.hide(), 
            this.css.jq.pause.show()) : (this.css.jq.play.show(), this.css.jq.pause.hide())), this.css.jq.restoreScreen.length && this.css.jq.fullScreen.length && (this.status.noFullWindow ? (this.css.jq.fullScreen.hide(), 
        ...
        _updateInterface : function ()
        {
            ...
            d = c - this.status.currentTime), b = this.options.remainingDuration ? (d > 0 ? "-" : "") + this._convertTime(d) : this._convertTime(c)), 
        ...
        setMedia : function (b)
        {
            ...
            this._resetMedia(), this._resetGate(), this._resetActive(), this.androidFix.setMedia = !1, 
            this.androidFix.play = !1, this.androidFix.pause = !1, b = this._absoluteMediaUrls(b), a.each(this.formats, 
            function (e, f)
            {
                ...
                return a.each(c.solutions, function (e, h)
                {
                    ...
                    {
                        var i = "html" === h;
                        return g ? (i ? (c.html.video.gate = !0, c._html_setVideo(b), c.html.active = !0) : (c.flash.gate = !0, 
                        c._flash_setVideo(b), c.flash.active = !0), c.css.jq.videoPlay.length && c.css.jq.videoPlay.show(), 
                        c.status.video = !0) : (i ? (c.html.audio.gate = !0, c._html_setAudio(b), c.html.active = !0, 
                        a.jPlayer.platform.android && (c.androidFix.setMedia = !0)) : (c.flash.gate = !0, 
                        c._flash_setAudio(b), c.flash.active = !0), c.css.jq.videoPlay.length && c.css.jq.videoPlay.hide(), 
            ...
            this.css.jq.title.length && "string" == typeof b.title && (this.css.jq.title.html(b.title), 
            this.htmlElement.audio && this.htmlElement.audio.setAttribute("title", b.title), this.htmlElement.video && this.htmlElement.video.setAttribute("title", 
            b.title)), this.status.srcSet = !0, this.status.media = a.extend({},
            b), this._updateButtons(!1), this._updateInterface(), this._trigger(a.jPlayer.event.setmedia)) : this._error(
            {
                type : a.jPlayer.error.NO_SUPPORT, context : "{supplied:'" + this.options.supplied + "'}", 
                message : a.jPlayer.errorMsg.NO_SUPPORT, hint : a.jPlayer.errorHint.NO_SUPPORT
            })
        },
        ...
        tellOthers : function (b, c)
        {
            ...
            {
                d.element !== this && (!e || c.call(this.data("jPlayer"), d)) && this.jPlayer.apply(this, 
                f)
            }))
        },
        ...
        {
            this.options.muted = b, this.html.used && this._html_setProperty("muted", b), this.flash.used && this._flash_mute(b), 
            this.html.video.gate || this.html.audio.gate || (this._updateMute(b), this._updateVolume(this.options.volume), 
        ...
        {
            a === b && (a = this.options.muted), this.css.jq.mute.length && this.css.jq.unmute.length && (this.status.noVolume ? (this.css.jq.mute.hide(), 
        ...
        {
            b = this._limitValue(b, 0, 1), this.options.volume = b, this.html.used && this._html_setProperty("volume", 
            b), this.flash.used && this._flash_volume(b), this.html.video.gate || this.html.audio.gate || (this._updateVolume(b), 
            this._trigger(a.jPlayer.event.volumechange));
        },
        volumeBar : function (b)
        {
            ...
            {
                var c = a(b.currentTarget), d = c.offset(), e = b.pageX - d.left, f = c.width(), g = c.height() - b.pageY + d.top, 
                h = c.height();
        ...
        {
            a === b && (a = this.options.volume), a = this.options.muted ? 0 : a, this.status.noVolume ? (this.css.jq.volumeBar.length && this.css.jq.volumeBar.hide(), 
        ...
        _cssSelectorAncestor : function (b)
        {
            ...
            {
                type : a.jPlayer.warning.CSS_SELECTOR_COUNT, context : b, message : a.jPlayer.warningMsg.CSS_SELECTOR_COUNT + this.ancestorJq.length + " found for cssSelectorAncestor.", 
                hint : a.jPlayer.warningHint.CSS_SELECTOR_COUNT
            }), this._addUiClass(), a.each(this.options.cssSelector, function (a, b)
            {
                c._cssSelector(a, b)
            }), this._updateInterface(), this._updateButtons(), this._updateAutohide(), this._updateVolume(), 
            this._updateMute()
        },
        _cssSelector : function (b, c)
        {
            ...
            if ("string" == typeof c)
            {
                if (a.jPlayer.prototype.options.cssSelector[b]) 
                {
                    ...
                    this.options.cssSelector[b] = c, this.css.cs[b] = this.options.cssSelectorAncestor + " " + c, 
                    this.css.jq[b] = c ? a(this.css.cs[b]) : [], this.css.jq[b].length && this [b]) 
                    {
                        var e = function (c) 
                        {
                    ...
                    {
                        type : a.jPlayer.warning.CSS_SELECTOR_COUNT, context : this.css.cs[b], message : a.jPlayer.warningMsg.CSS_SELECTOR_COUNT + this.css.jq[b].length + " found for " + b + " method.", 
                        hint : a.jPlayer.warningHint.CSS_SELECTOR_COUNT 
                    }) 
                }
                else
                {
                    this._warning( 
                    {
                        type : a.jPlayer.warning.CSS_SELECTOR_METHOD, context : b, message : a.jPlayer.warningMsg.CSS_SELECTOR_METHOD, 
                ...
                else
                {
                    this._warning( 
                    {
                        type : a.jPlayer.warning.CSS_SELECTOR_STRING, context : c, message : a.jPlayer.warningMsg.CSS_SELECTOR_STRING, 
        ...
        playbackRateBar : function (b)
        {
            if (this.css.jq.playbackRateBar.length)
            {
                ...
                c = this.options.verticalPlaybackRate ? i / j : g / h, d = c * (this.options.maxPlaybackRate - this.options.minPlaybackRate) + this.options.minPlaybackRate, 
                this.playbackRate(d);
            }
        },
        _updatePlaybackRate : function ()
        {
            ...
            this.css.jq.playbackRateBarValue.length && (this.css.jq.playbackRateBarValue.show(), this.css.jq.playbackRateBarValue[this.options.verticalPlaybackRate ? "height" : "width"](100 * b + "%"))) : (this.css.jq.playbackRateBar.length && this.css.jq.playbackRateBar.hide(), 
                ...
                if (d === b)
                {
                    for (var g = a.extend(!0, {}, this.options), h = 0; h < f.length; h++)
                    {
                        if (g[f[h]] === b)
                        {
                            ...
                            {
                                type : a.jPlayer.warning.OPTION_KEY, context : c, message : a.jPlayer.warningMsg.OPTION_KEY, 
        ...
        _setOption : function (b, c)
        {
            ...
            switch (b)
            {
                ...
                case "playbackRate":
                    ...
                    this.html.used && this._html_setProperty("playbackRate", c), this._updatePlaybackRate();
                    break;
                case "defaultPlaybackRate":
                    this.options[b] = c = this._limitValue(c, this.options.minPlaybackRate, this.options.maxPlaybackRate), 
                    this.html.used && this._html_setProperty("defaultPlaybackRate", c), this._updatePlaybackRate();
                    break;
                ...
                case "size":
                    ...
                    this.options[b] = a.extend({}, this.options[b], c), this._refreshSize();
                    break;
                case "sizeFull":
                    this.options.fullWindow && this.options[b].cssClass !== c.cssClass && this._removeUiClass(), 
                    this.options[b] = a.extend({}, this.options[b], c), this._refreshSize();
                ...
                case "nativeVideoControls":
                    this.options[b] = a.extend({}, this.options[b], c), this.status.nativeVideoControls = this._uaBlocklist(this.options.nativeVideoControls), 
                    this._restrictNativeVideoControls(), this._updateNativeVideoControls();
                    break;
                case "noFullWindow":
                    this.options[b] = a.extend({}, this.options[b], c), this.status.nativeVideoControls = this._uaBlocklist(this.options.nativeVideoControls), 
                    this.status.noFullWindow = this._uaBlocklist(this.options.noFullWindow), this._restrictNativeVideoControls(), 
                    this._updateButtons();
                    break;
                case "noVolume":
        ...
        {
            this._setSize(), this._addUiClass(), this._updateSize(), this._updateButtons(), this._updateAutohide(), 
            this._trigger(a.jPlayer.event.resize)
        },
        _setSize : function ()
        {
            this.options.fullWindow ? (this.status.width = this.options.sizeFull.width, this.status.height = this.options.sizeFull.height, 
        ...
        _updateAutohide : function ()
        {
            ...
            this.element.unbind(c), this.css.jq.gui.unbind(c), this.status.nativeVideoControls ? this.css.jq.gui.hide() : this.options.fullWindow && this.options.autohide.full || !this.options.fullWindow && this.options.autohide.restored ? (this.element.bind(d, 
            e), this.css.jq.gui.bind(d, e), this.css.jq.gui.hide()) : this.css.jq.gui.show())
        },
        fullScreen : function ()
        {
        ...
        _fullscreenAddEventListeners : function ()
        {
            ...
            {
                b._fullscreenchange()
            }), document.addEventListener(c.event.fullscreenchange, this.internal.fullscreenchangeHandler, 
            !1))
        },
        _fullscreenRemoveEventListeners : function ()
        {
            var b = a.jPlayer.nativeFeatures.fullscreen;
            this.internal.fullscreenchangeHandler && document.removeEventListener(b.event.fullscreenchange, 
            this.internal.fullscreenchangeHandler, !1)
        },
        _fullscreenchange : function ()
        {
            this.options.fullScreen && !a.jPlayer.nativeFeatures.fullscreen.api.fullscreenElement() && this._setOption("fullScreen", 
            !1)
        },
        ...
        _html_initMedia : function (b)
        {
            ...
            a.each(b.track || [], function (a, b)
            {
                ...
                d.setAttribute("kind", b.kind ? b.kind : ""), d.setAttribute("src", b.src ? b.src : ""), 
                d.setAttribute("srclang", b.srclang ? b.srclang : ""), d.setAttribute("label", b.label ? b.label : ""), 
                b.def && d.setAttribute("default", b.def), c.append(d)
        ...
        _html_setFormat : function (b)
        {
            ...
            {
                return c.html.support[d] && b[d] ? (c.status.src = b[d], c.status.format[d] = !0, c.status.formatType = d, 
                !1) : void 0;
            })
        },
        ...
        {
            this._html_setFormat(a), this.status.nativeVideoControls && (this.htmlElement.video.poster = this._validString(a.poster) ? a.poster : ""), 
            this.htmlElement.media = this.htmlElement.video, this._html_initMedia(a);
        },
        ...
        {
            var b = this, c = this.htmlElement.media;
            if (this.androidFix.play = !1, a > 0 ? this._html_load() : clearTimeout(this.internal.htmlDlyCmdId), 
            c.pause(), this.androidFix.setMedia) this.androidFix.pause = !0, this.androidFix.time = a;
            else if (!isNaN(a)) try
            {
                if (c.seekable && !("object" == typeof c.seekable && c.seekable.length > 0)) {
                    throw 1;
            ...
            try
            {
                a.each(this.formats, function (a, d)
                {
                    if (c.flash.support[d] && b[d])
                    {
                        ...
                        return c.status.src = b[d], c.status.format[d] = !0, c.status.formatType = d, 
                        !1;
                    }
        ...
        _getFlashPluginVersion : function ()
        {
            ...
            if (window.ActiveXObject)
            {
                try 
                {
                    if (a = new ActiveXObject("ShockwaveFlash.ShockwaveFlash")) 
                    {
                        ...
                        c && (c = c.split(" ")[1].split(","), b = parseInt(c[0], 10) + "." + parseInt(c[1], 
                        10));
                    }
                }
                catch (d) {}
            ...
            else
            {
                ...
                a && (b = navigator.plugins["Shockwave Flash"].description.replace(/.*\s(\d+\.\d+).*/, 
                "$1")));
            }
            return 1 * b;
        },
        ...
        _urlNotSetError : function (b)
        {
            this._error(
            {
                type : a.jPlayer.error.URL_NOT_SET, context : b, message : a.jPlayer.errorMsg.URL_NOT_SET, 
        ...
        _flashError : function (b)
        {
            ...
            {
                type : a.jPlayer.error[c], context : this.internal.flash.swf, message : a.jPlayer.errorMsg[c] + b.message, 
    ...
    a.jPlayer.error = 
    {
        FLASH : "e_flash", FLASH_DISABLED : "e_flash_disabled", NO_SOLUTION : "e_no_solution", NO_SUPPORT : "e_no_support", 
    ...
    a.jPlayer.errorMsg = 
    {
        ...
        URL : "Media URL could not be loaded.", URL_NOT_SET : "Attempt to issue media playback commands, while no media url is set.", 
    ...
    a.jPlayer.errorHint = 
    {
        ...
        NO_SOLUTION : "Review the jPlayer options: support and supplied.", NO_SUPPORT : "Video or audio formats defined in the supplied option are missing.", 
    ...
    {
        CSS_SELECTOR_COUNT : "The number of css selectors found did not equal one: ", CSS_SELECTOR_METHOD : "The methodName given in jPlayer('cssSelector') is not a valid jPlayer method.", 
        CSS_SELECTOR_STRING : "The methodCssSelector given in jPlayer('cssSelector') is not a String or is empty.", 
        OPTION_KEY : "The option requested in jPlayer('option') is undefined."
    },
    a.jPlayer.warningHint = 
    {
        CSS_SELECTOR_COUNT : "Check your css selector and the ancestor.", CSS_SELECTOR_METHOD : "Check your method name.", 
        CSS_SELECTOR_STRING : "Check your css selector is a string.", OPTION_KEY : "Check your option name."
    }
}), function (a, b)
{
    jPlayerPlaylist = function (b, c, d)
    {
        ...
        this._options, d), this.playlist = [], this.original = [], this._initPlaylist(c), this.cssSelector.title = this.cssSelector.cssSelectorAncestor + " .jp-title", 
        this.cssSelector.playlist = this.cssSelector.cssSelectorAncestor + " .jp-playlist", this.cssSelector.next = this.cssSelector.cssSelectorAncestor + " .jp-next", 
        this.cssSelector.previous = this.cssSelector.cssSelectorAncestor + " .jp-previous", this.cssSelector.shuffle = this.cssSelector.cssSelectorAncestor + " .jp-shuffle", 
        this.cssSelector.shuffleOff = this.cssSelector.cssSelectorAncestor + " .jp-shuffle-off", this.cssSelector.repeatone = this.cssSelector.cssSelectorAncestor + " .jp-repeatone", 
        this.cssSelector.repeatoneOff = this.cssSelector.cssSelectorAncestor + " .jp-repeatone-off", this.options.cssSelectorAncestor = this.cssSelector.cssSelectorAncestor, 
        ...
        {
            return e.options.playlistOptions.repeatone = !1, a(e.cssSelector.repeatone).hide(), a(e.cssSelector.repeatoneOff).show(), 
            !1
        }), a(this.cssSelector.repeatoneOff).click(function ()
        {
            return e.options.playlistOptions.repeatone = !0, a(e.cssSelector.repeatoneOff).hide(), a(e.cssSelector.repeatone).show(), 
            !1
        }), this.options.fullScreen || a(this.cssSelector.title).hide(), a(this.cssSelector.playlist + " ul").empty(), 
        this._createItemHandlers(), a(this.cssSelector.jPlayer).jPlayer(this.options)
    },
    jPlayerPlaylist.prototype = 
    {
        ...
        _options : 
        {
            playlistOptions : 
            {
                autoPlay :!1, loopOnPrevious :!1, shuffleOnLoop :!0, enableRemoveControls :!1, displayTime : "slow", 
                addTime : "fast", removeTime : "fast", shuffleTime : "slow", itemClass : "jp-playlist-item", 
        ...
        {
            this.current = 0, this.shuffled = !1, this.removing = !1, this.original = a.extend(!0, [], 
            b), this._originalPlaylist();
        },
        ...
        _createListItem : function (b)
        {
            ...
            {
                var e = !0;
                d += "<span class='" + this.options.playlistOptions.freeGroupClass + "'>(", a.each(b, 
                function (b, f)
                {
                    a.jPlayer.prototype.format[b] && (e ? e = !1 : d += " | ", d += "<a class='" + c.options.playlistOptions.freeItemClass + "' href='" + f + "' tabindex='1'>" + b + "</a>")
                }), d += ")</span>"
            }
            return d += "<a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='1'>" + b.title + (b.artist ? " <span class='jp-artist'>by " + b.artist + "</span>" : "") + "</a>", 
            d += "</div></li>"
        },
        _createItemHandlers : function ()
        {
            var b = this;
            a(this.cssSelector.playlist).off("click", "a." + this.options.playlistOptions.itemClass).on("click", 
            "a." + this.options.playlistOptions.itemClass, function ()
            {
                var c = a(this).parent().parent().index();
                return b.current !== c ? b.play(c) : a(b.cssSelector.jPlayer).jPlayer("play"), a(this).blur(), 
                !1
            }), a(this.cssSelector.playlist).off("click", "a." + this.options.playlistOptions.freeItemClass).on("click", 
            "a." + this.options.playlistOptions.freeItemClass, function ()
            {
                return a(this).parent().parent().find("." + b.options.playlistOptions.itemClass).click(), 
                a(this).blur(), !1
            }), a(this.cssSelector.playlist).off("click", "a." + this.options.playlistOptions.removeItemClass).on("click", 
            "a." + this.options.playlistOptions.removeItemClass, function ()
            {
                var c = a(this).parent().parent().index();
        ...
        _updateControls : function ()
        {
            ...
            this.shuffled ? (a(this.cssSelector.shuffleOff).show(), a(this.cssSelector.shuffle).hide()) : (a(this.cssSelector.shuffleOff).hide(), 
            a(this.cssSelector.shuffle).show()), this.options.playlistOptions.repeatone ? (a(this.cssSelector.repeatone).show(), 
            a(this.cssSelector.repeatoneOff).hide()) : (a(this.cssSelector.repeatone).hide(), a(this.cssSelector.repeatoneOff).show())
        },
        ...
        add : function (b, c)
        {
            ...
            this._updateControls(), this.original.push(b), this.playlist.push(b), c ? this.play(this.playlist.length - 1) : 1 === this.original.length && this.select(0)
        },
        remove : function (c)
        {
            var d = this;
            ...
            }), !0) : this.removing ?!1 : (c = 0 > c ? d.original.length + c : c, c >= 0 && c < this.playlist.length && (this.removing = !0, 
            ...
            function ()
            {
                ...
                d.current = 0, d.shuffled = !1, d._updateControls()), d.removing = !1;
            })), !0)
        },
        select : function (b)
        {
            b = 0 > b ? this.original.length + b : b, b >= 0 && b < this.playlist.length ? (this.current = b, 
            this._highlight(b), a(this.cssSelector.jPlayer).jPlayer("setMedia", this.playlist[this.current])) : this.current = 0;
        },
        play : function (c)
        {
            c = 0 > c ? this.original.length + c : c, c >= 0 && c < this.playlist.length ? this.playlist.length && (this.select(c), 
        ...
        next : function ()
        {
            ...
            this.loop ? 0 === a && this.shuffled && this.options.playlistOptions.shuffleOnLoop && this.playlist.length > 1 ? this.shuffle(!0, 
            !0) : this.play(a) : a > 0 && this.play(a)
        },
        previous : function ()
        {
        ...
        {
            var e = this;
            c === b && (c = !this.shuffled), (c || c !== this.shuffled) && a(this.cssSelector.playlist + " ul").slideUp(this.options.playlistOptions.shuffleTime, 
            function ()
            {
                e.shuffled = c, c ? e.playlist.sort(function ()
                {
                    return.5 - Math.random()
                }) : e._originalPlaylist(), e._refresh(!0), d || !a(e.cssSelector.jPlayer).data("jPlayer").status.paused ? e.play(0) : e.select(0), 
...
(jQuery), function ($)
{
    $.luoo = 
    {
        ...
        init : function (a)
        {
            return this.root = a.root ? a.root : document.location.href, this.url_static = a.url_static ? a.url_static : this.root + "/static", 
            this.res = a.res ? a.res : {}, this.cfg = a.cfg ? a.cfg : {}, this
        },
        ...
        get : function (url, data, cback, object, async)
        {
            async = async === !0 ?!0 :!1, $.ajax({
                type : "get", url : url, data : data, dataType : "json", async : async
            }).done(function (json)
            {
                try {
                    eval("var func = " + cback), func(json, object)
        ...
        browser : function ()
        {
            ...
            return {
                version : a.match(/(?:firefox|opera|safari|chrome|msie)[\/: ]([\d.]+)/)[1], safari : /version.+safari/.test(a), 
                chrome : /chrome/.test(a), firefox : /firefox/.test(a), ie : /msie/.test(a), opera : /opera/.test(a)
            }
        },
        destroy_tip : function (a)
        {
            ...
            {
                !c || a && c.id != a || c.destroy(), c && a && c.id == a ? $.luoo.tips.splice(b, 1) : $.luoo.tips.splice(0, 
                $.luoo.tips.length)
            })
        },
        msg : function (a, b, c, d, e)
        {
            var f = "undefined" == typeof c ?!1 : c, g = "undefined" == typeof d ? "none" : d, e = "undefined" == typeof e ? null : e, 
            h = {
                title : a, content : b, ok : f, cancle :!1, lock : "none" != g, background : g, width : 410, 
                close : e
            };
            this.openedMsg = art.dialog(h);
        },
        close_msg : function ()
        {
    ...
    $.fn.luooTab = function (a)
    {
        return $(".tab-item").removeClass("actived"), $(".tab-content-item").hide(), $(this).each(function () {
            var b = $(this), c = 0;
            a && (c = $("#tab-" + a).index()), $(".tab-item", b).eq(c).addClass("actived"), $(".tab-content-item", 
            b).hide(), $(".tab-content-item", b).eq(c).show(), b.find(".tab-item").on("click", function ()
            {
                var a = $(this), c = a.index();
                $(".tab-item", b).removeClass("actived"), a.addClass("actived"), $(".tab-content-item", 
                b).hide(), $(".tab-content-item", b).eq(c).fadeIn(300)
            })
        })
    },
    $.fn.getComments = function ()
    {
        return $(this).each(function () {
            var a = $(this);
            $.luoo.post(a.data("url"), a.data(), "get_comment_callback", a), a.on("click", ".ajax-comment-pager a", 
            function (b)
            {
                b.preventDefault(), $.luoo.post($(this).attr("href"), "", "get_comment_callback", a)
            }), $(".ln-comment-sort").click(function (b)
            {
                b.preventDefault(), $.luoo.post($(this).data("url"), "", "get_comment_callback", a), $(".ln-comment-sort").removeClass("current"), 
...
(jQuery), $(document).ready(function ()
{
    check_login(), $("body").on("submit", ".form-ajax", function (evt)
    {
        ...
        if ($form.data("disabled", !0), $form.is($(".form-valid")) && 0 == $form.data("valid-result")) {
            return!1;
        }
        var cback = function () {};
        return $form.attr("callback") && (cback = $form.attr("callback")), $.luoo.post($form.attr("action"), 
        $form.serialize(), cback, $form), !0
    }), $("body").on("click", ".ajax", function (evt)
    {
        ...
        var data = {};
        return $this.data("param") && eval("data = " + $this.data("param")), $.luoo.post($this.attr("href"), 
        data, cback, $this), !1
    }), $("body").on("click", ".btn-action-like", function (a)
    {
        a.preventDefault();
        var b = $(this);
        if ($("#qtip-" + b.data("tipid")).is("div")) {
            return!1;
        }
        var b = $(this);
        if (b.data("disabled")) {
        ...
        if (b.data("confirm") && !confirm(b.data("confirm"))) {
            return!1;
        }
        var c = b.data("id"), d = b.data("type"), e = (b.data("fav"), "like_callback");
        return b.data("cback") && (e = b.data("cback")), c ? (b.data("disabled", !0), $.luoo.post($.luoo.root + "/user/like", 
        {
            id : c, res : $.luoo.res.app[d]
        }, e, b), !1) :!1
    ...
    if ($(".util-luoo-tabs").luooTab(map), 1 != $.cookie("tipsclose") && $("#announcement").slideDown(200), 
    ...
    }), $(".container").css("minHeight", $(window).height() - 422), $("body").on("mouseenter", "#lnMessage", 
    function ()
    {
        $(this).tip()
    ...
    }), $("body").on("click", ".btn-login-submit", function ()
    {
        ...
        return $.trim(a.find('[name="name"]').val()) && $.trim(a.find('[name="password"]').val()) ? void a.submit() : ($(".btn-login-submit").hide(), 
        $(".btn-login-msg").text("邮箱或密码不能为空").show(), !1)
    ...
    {
        var a = $(this).parents("form");
        return $.trim(a.find('[name="name"]').val()) && $.trim(a.find('[name="password"]').val()) ? void a.submit() : ($(".btn-register-submit").hide(), 
        $(".btn-register-msg").text("请完善未填项目").show(), !1)
    }), $("body").on("focus", ".input-passport", function ()
    {
    ...
    }), $("body").on("keyup", function (a)
    {
        if (13 == a.keyCode)
        {
            if ($(".btn-register-submit").is($(":visible"))) {
                return void $(".btn-register-submit").click();
            }
            if ($(".btn-login-submit").is($(":visible"))) {
                return void $(".btn-login-submit").click();
            }
        }
    ...
    }), $("body").on("click", ".btn-add-lyric", function ()
    {
        ...
        function (a, b)
        {
            ...
            {
                var c = b.tip({
                    remote : $.luoo.root + "/login/dialog", width : 235
                });
                c.set("events.hide", function (a, b)
                {
                    b.destroy(), $.luoo.destroy_tip(b.id)
                ...
                a && ($.luoo.close_msg(), $.luoo.msg("添加歌词", a.data));
            }
        },
        $(this))
    ...
    {
        var a = $(this);
        return a.data("user") && a.data("uid") ? void $.luoo.get(url("mail/send"), {},
        function (a, b)
        {
            if (-1 == a.status)
            {
