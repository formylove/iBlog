...
<s:if test="opus == null">
<p class="essay-meta">
				<span class="cursor-pointer" onclick="window.location.href='essayAction.action?method:edit&id=${essay.id}'">修改</span>・
...
<p class="margin-b-25" style="margin-top: 0;  padding: 0;">
				<span class="cursor-pointer" onclick="window.location.href='noteAction.action?method:edit&id=${essay.id}'">修改</span>・
